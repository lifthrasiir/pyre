...
pub use call_descr::{
    ...
    EffectInfoSlot, INT_PY_DIV_EFFECT_INFO, INT_PY_MOD_EFFECT_INFO, LOOPINVARIANT_EFFECT_INFO,
    effect_info_for_slot, make_call_assembler_descr, make_call_assembler_descr_by_number,
