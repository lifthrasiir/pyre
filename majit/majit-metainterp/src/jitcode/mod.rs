...
pub use majit_translate::insns::{
    ...
    BC_CALL_MAY_FORCE_FLOAT, BC_CALL_MAY_FORCE_INT, BC_CALL_MAY_FORCE_REF, BC_CALL_PURE_FLOAT,
    BC_CALL_PURE_INT, BC_CALL_PURE_REF, BC_CALL_REF, BC_CALL_RELEASE_GIL_FLOAT,
    BC_CALL_RELEASE_GIL_INT, BC_CATCH_EXCEPTION, BC_COND_CALL_VALUE_INT, BC_COND_CALL_VALUE_REF,
    BC_COND_CALL_VOID, BC_FLOAT_ABS, BC_FLOAT_ADD, BC_FLOAT_GUARD_VALUE, BC_FLOAT_MUL,
    BC_FLOAT_NEG, BC_FLOAT_POP, BC_FLOAT_PUSH, BC_FLOAT_RETURN, BC_FLOAT_SUB, BC_FLOAT_TRUEDIV,
    BC_GETARRAYITEM_VABLE_F, BC_GETARRAYITEM_VABLE_I, BC_GETARRAYITEM_VABLE_R, BC_GETFIELD_VABLE_F,
    BC_GETFIELD_VABLE_I, BC_GETFIELD_VABLE_R, BC_GOTO_IF_EXCEPTION_MISMATCH,
    BC_GOTO_IF_NOT_FLOAT_EQ, BC_GOTO_IF_NOT_FLOAT_GE, BC_GOTO_IF_NOT_FLOAT_GT,
    BC_GOTO_IF_NOT_FLOAT_LE, BC_GOTO_IF_NOT_FLOAT_LT, BC_GOTO_IF_NOT_FLOAT_NE,
    BC_GOTO_IF_NOT_INT_EQ, BC_GOTO_IF_NOT_INT_GE, BC_GOTO_IF_NOT_INT_GT,
